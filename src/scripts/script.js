...
connectButton.addEventListener("click",()=>{
  ...
  else if (connectButton.textContent=="Connected"){
    checkLogout();
  }
});
...
function renderComments(comments, parentElement) {
  for (let i = comments.length - 1; i >= 0; i--) {
    ...
    commentElement.innerHTML = `
      <div class="votes">
        <button class="vote-btn upvote" data-vote="up"><img src="images/thumbs-up.svg" alt="Upvote"></button>
        <span class="votes-count">${totalVotes}</span>
        <button class="vote-btn downvote" data-vote="down"><img src="images/thumbs-down.svg" alt="Downvote"></button>
      </div>
